...
namespace GUI
{
    ...
    void Draw()
    {
        ...
        if (MousePacket[0] & PS2Leftbutton || MousePacket[0] & PS2Rightbutton) {
            if(!isPowerMenuOpen) {
                ...
                if(MousePosition.X > 75 && MousePosition.X < 200) {
                    if (MousePosition.Y > WindowStuff->ResoHeight - 150 && MousePosition.Y < WindowStuff->ResoHeight - 130)
                    {
                        UnInit();
                        Shutdown();
                    }
                    else if (MousePosition.Y > WindowStuff->ResoHeight - 130 && MousePosition.Y < WindowStuff->ResoHeight - 100)
                    {
                        UnInit();
                        Reboot();
                    }
            ...
            if (WindowStuff->StartMenuStatus == true && MousePosition.X <= 300 && !isPowerMenuOpen)
                ...
                else if (MousePosition.Y >= WindowStuff->ResoHeight - 155 && MousePosition.Y <= WindowStuff->ResoHeight - 145) {
